    ...
    <defs>
      <clipPath id="clip0_1_6236">
        <rect width="190" height="42" fill="white"/>
          ...
          <nav 
            className={`${menuOpen ? 'block fade-in' : 'hidden'} lg:hidden fixed left-4 right-4 top-[120px] z-50 bg-black/80 backdrop-blur-[12.5px] rounded-lg border border-white/10 hover-glow`}
            style={{
