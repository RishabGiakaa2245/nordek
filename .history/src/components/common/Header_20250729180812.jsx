  ...
  return (
    <header className="w-full">
      <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        ...
        <div className="relative z-10 flex items-center justify-between px-8 lg:px-[177px] py-6 bg-black/20 backdrop-blur-[12.5px] rounded-[20px] border border-white/10" 
             >
          {/* Logo */}
