    ...
    <defs>
      <clipPath id="clip0_1_6236">
        <rect width="190" height="42" fill="white"/>
          ...
          <nav 
            className={`${menuOpen ? 'translate-y-0 opacity-100' : 'translate-y-[-20px] opacity-0 pointer-events-none'} lg:hidden fixed top-[10px] left-0 right-0 mx-4 transition-all duration-300 ease-in-out bg-black/40 backdrop-blur-[12.5px] rounded-lg border border-white/10 hover-glow z-50`}
            style={{
