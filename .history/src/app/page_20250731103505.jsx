...
{/* About Us Section */}
      ...
      <img
        ...
        className="w-[78px] h-[80px] relative left-[95vw] sm:w-[117px] sm:h-[120px] lg:w-[156px] lg:h-[160px] mr-[42px] sm:mr-[63px] lg:mr-[84px] z-50 animate-float-glow"
        animate={{ y: [0, -10, 0] }}
      />
          ...
          <div className="flex flex-col gap-[60px] sm:gap-[90px] lg:gap-[120px] justify-start items-center w-full">
            <div className="flex flex-col gap-[42px] sm:gap-[63px] lg:gap-[84px] justify-start items-center w-full">
              ...
              <motion.div 
                ...
                className="flex flex-col sm:flex-row gap-[19px] sm:gap-[28px] lg:gap-[38px] justify-center items-center sm:items-end w-full"
              >
                {features.map((feature, index) => (
                  ...
                  >
                    <motion.div
                      ...
                      viewport={{ once: true }}
                      transition={{ duration: 0.3 }}
                      className="absolute -bottom-1/2 left-1/2 -translate-x-1/2 w-[100%] h-[100%] bg-[#4bc3ff] blur-[50px] rounded-full"
                    ></motion.div>
                    <motion.img
                    ...
                    <motion.div 
                      ...
                      className="flex flex-col gap-[3px] sm:gap-[4px] lg:gap-[6px] justify-start items-start w-full"
                    >
                      <motion.h4
                        initial={{ opacity: 0 }}
                        whileInView={{ opacity: 1 }}
                        ...
                        className="text-[10px] sm:text-[15px] lg:text-[20px] font-poppins font-semibold leading-[15px] sm:leading-[22px] lg:leading-[30px] text-left text-global-2"
                      >
                        {feature.title}
                      </motion.h4>
                      <motion.p
                        ...
                        className="text-[7px] sm:text-[10px] lg:text-[14px] font-poppins font-normal leading-[10px] sm:leading-[15px] lg:leading-[21px] text-left text-global-3 w-full"
                      >
                        {feature.description}
                      </motion.p>
                    </motion.div>
                ...
                >
                  ...
                  >
                    ...
                    <motion.p
                      ...
                      className="text-[10px] sm:text-[15px] lg:text-[20px] font-medium leading-[15px] sm:leading-[22px] lg:leading-[30px] text-center text-cyan-400 px-3 whitespace-nowrap"
                    >
                      Partners
                    </motion.p>
                    <motion.div
                  ...
                  <motion.h2
                    ...
                    viewport={{ once: true }}
                    transition={{ duration: 0.8, delay: 0.4 }}
                    className="text-[32px] sm:text-[48px] lg:text-[64px] font-poppins font-semibold leading-[48px] sm:leading-[72px] lg:leading-[96px] text-center text-global-2"
                  >
                  ...
                  <motion.p
                    ...
                    viewport={{ once: true }}
                    transition={{ duration: 0.8, delay: 0.6 }}
                    className="text-[10px] sm:text-[15px] lg:text-[20px] font-poppins font-normal leading-[15px] sm:leading-[22px] lg:leading-[30px] text-center text-global-3 w-full"
                  >
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3 sm:gap-4 lg:gap-6 auto-rows-fr">
                      {partnerLogos.flat().map((logo, logoIndex) => (
                        <motion.div
                          ...
                          transition={{ 
                            duration: 0.6,
                            delay: 0.1 * (logoIndex % 5), // Stagger by row
                            type: "spring",
                            stiffness: 200
                          }}
                          whileHover={{ 
                        ...
                        >
                          ...
                          {logoIndex === 13 ? (
                            ...
                            <motion.img
                              ...
                              className={`w-[${Math.floor(parseInt(logo.width) * 0.5)}px] h-[${Math.floor(parseInt(logo.height) * 0.5)}px] sm:w-[${Math.floor(parseInt(logo.width) * 0.75)}px] sm:h-[${Math.floor(parseInt(logo.height) * 0.75)}px] lg:w-[${logo.width}px] lg:h-[${logo.height}px] object-contain transition-all`}
                            />
                          )}
                        </motion.div>
                      ))}
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              className="flex flex-row justify-start items-center w-full max-w-[1234px] mb-[30px] sm:mb-[45px] lg:mb-[60px]"
            >
              <motion.div 
                initial={{ opacity: 0 }}
                whileInView={{ opacity: 1 }}
                viewport={{ once: true }}
                transition={{ duration: 0.6, delay: 0.2 }}
                className="flex flex-col gap-[23px] sm:gap-[34px] lg:gap-[46px] justify-center items-center w-full border border-button-1 rounded-[10px] sm:rounded-[15px] lg:rounded-[20px] bg-global-2 pt-[23px] pr-[23px] pb-[23px] pl-[23px] sm:pt-[34px] sm:pr-[34px] sm:pb-[34px] sm:pl-[34px] lg:pt-[46px] lg:pr-[46px] lg:pb-[46px] lg:pl-[46px]"
              >
                <motion.div 
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                ...
                >
                  <div className="flex flex-col gap-[32px] sm:gap-[48px] lg:gap-[64px] justify-start items-start self-end w-full">
                    ...
                    >
                      <motion.button 
                        ...
                        whileTap={{ scale: 0.95 }}
                        transition={{ type: "spring", stiffness: 400, damping: 10 }}
                        className="border border-[#191919] rounded-[6px] sm:rounded-[9px] lg:rounded-[12px] pt-[6px] pr-[6px] pb-[6px] pl-[6px] sm:pt-[9px] sm:pr-[9px] sm:pb-[9px] sm:pl-[9px] lg:pt-[12px] lg:pr-[12px] lg:pb-[12px] lg:pl-[12px]">
                        <img
                  ...
                  <motion.div 
                    ...
                    viewport={{ once: true }}
                    transition={{ duration: 0.6, delay: 0.7 }}
                    className="flex flex-row gap-[24px] sm:gap-[36px] lg:gap-[48px] w-[40%]"
                  >
                    <motion.div
                      initial={{ opacity: 0, y: 20 }}
                      whileInView={{ opacity: 1, y: 0 }}
                      ...
                      className="flex flex-col gap-[8px] sm:gap-[12px] lg:gap-[16px] justify-start items-start w-[166px]"
                    >
                      <motion.p
                        initial={{ opacity: 0 }}
                        whileInView={{ opacity: 1 }}
                        ...
                        className="text-[10px] sm:text-[15px] lg:text-[20px] font-poppins font-medium leading-[15px] sm:leading-[22px] lg:leading-[30px] text-left text-global-2"
                      >
                        Company
                      </motion.p>
                    ...
                    <motion.div
                      ...
                      className="flex flex-col gap-[8px] sm:gap-[12px] lg:gap-[16px] justify-start items-start w-auto"
                    >
                      <motion.p
                        initial={{ opacity: 0 }}
                        whileInView={{ opacity: 1 }}
                        ...
                        className="text-[10px] sm:text-[15px] shrink-0 lg:text-[20px] font-poppins font-medium leading-[15px] sm:leading-[22px] lg:leading-[30px] text-left text-global-2"
                      >
                        Quick Links
                      </motion.p>
