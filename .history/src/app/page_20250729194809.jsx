      ...
      <div className="w-full relative min-h-[80vh]  sm:min-h-screen overflow-hidden">
        ...
        <div className="w-full max-w-[1440px] mx-auto relative z-10">
          <div className="flex flex-col justify-start items-center w-full">
            ...
            {/* Main Hero Content */}
            <div ref={heroRef} className="fade-in flex flex-col justify-start items-center w-full sm:mt-[42px] lg:mt-[56px] sm:mr-[132px] sm:ml-[88px] lg:mr-[176px] lg:ml-[118px]">
              <div className="flex flex-col justify-start items-center w-full">
                {/* Hero Title */}
                <div className="flex flex-col justify-start mt-14 sm:mt-0 items-center w-full relative z-20">
                  <div className="stagger-delay flex flex-row gap-[10px] sm:gap-[15px] lg:gap-[20px] justify-center items-center w-auto">
                    <h1 className="fade-up text-[28px] sm:text-[72px] lg:text-[96px] font-poppins font-semibold leading-[50px] sm:leading-[108px] lg:leading-[144px] text-left uppercase text-global-2 drop-shadow-lg hover-scale">
                      Empowering
                    </h1>
                    <h1 className="fade-up text-[28px] sm:text-[72px] lg:text-[96px] font-poppins font-semibold leading-[50px] sm:leading-[108px] lg:leading-[144px] text-right uppercase bg-[linear-gradient(134deg,#6a62fd_0%,_#4bc3ff_100%)] bg-clip-text text-transparent drop-shadow-lg hover-scale">
                      Finance
                    </h1>
                  </div>
                  <h1 className="fade-up text-[28px] sm:text-[72px] lg:text-[96px] font-poppins font-semibold leading-[50px] sm:leading-[108px] lg:leading-[144px] text-center uppercase text-global-2 mt-[-22px] sm:mt-[-33px] lg:mt-[-44px] drop-shadow-lg hover-scale">
                    Beyond Borders
                  </h1>
                </div>

                {/* Subtitle with Arrow */}
                <div className="fade-up delay-200 flex flex-row gap-[6px] sm:gap-[9px] lg:gap-[12px] justify-center items-center w-auto mt-[5px] sm:mt-[7px] lg:mt-[10px] relative z-20">
                  ...
                  <button className="hover-scale bg-global-5 rounded-[8px] sm:rounded-[12px] lg:rounded-[16px] pt-[3px] pr-[3px] pb-[3px] pl-[3px] sm:pt-[4px] sm:pr-[4px] sm:pb-[4px] sm:pl-[4px] lg:pt-[6px] lg:pr-[6px] lg:pb-[6px] lg:pl-[6px] hover:bg-global-5/80 transition-all duration-300">
                    <img
              ...
              <div className="fade-up delay-300 hover-scale relative w-full max-w-[320px] sm:max-w-[400px] lg:max-w-[480px] h-[140px] sm:h-[160px] lg:h-[180px] mt-20 my-[40px] sm:my-[55px] lg:my-[70px] z-30">
                {/* Card Background with enhanced glass effect */}
                <div
                  className="absolute inset-0 rounded-[15px] sm:rounded-[18px] lg:rounded-[20px] border border-white/20 bg-black/30 backdrop-blur-[15px] hover-glow"
                  style={{
                    boxShadow:
                ...
                <div className="relative z-10 flex flex-col items-center gap-3 sm:gap-4 lg:gap-6 px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8 h-full">
                  ...
                  <div className="flex items-center justify-center gap-3 sm:gap-5 lg:gap-8 stagger-delay">
                    {/* Bepay Business Logo */}
                    <div className="fade-up flex flex-col items-center hover-scale">
                      <img
              ...
              {/* Industry Partners */}
              <div className="fade-up delay-400 relative w-full mt-[65px] sm:mt-[97px] lg:mt-[130px] overflow-hidden z-30">
                <div className="flex gap-[10%] items-center animate-scroll whitespace-nowrap">
                  ...
                  {industryPartners.map((partner, index) => (
                    <img
                      ...
                      src={partner.src}
                      alt={`Partner ${index + 1}`}
                      className={`flex-shrink-0 hover-scale w-[${Math.floor(parseInt(partner.width) * 0.5)}px] h-[${Math.floor(parseInt(partner.height) * 0.5)}px] sm:w-[${Math.floor(parseInt(partner.width) * 0.75)}px] sm:h-[${Math.floor(parseInt(partner.height) * 0.5)}px] lg:w-[${partner.width}px] lg:h-[${partner.height}px] drop-shadow-sm`}
                    />
                  ))}
                </div>
              </div>
