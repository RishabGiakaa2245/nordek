...
<div className="bg-global-1 w-full">
      ...
      <div className="w-full mt-[6px] sm:mt-[9px] lg:mt-[12px]" ref={containerRef}>
              ...
              >
                {products.map((product, index) => (
                  <div
                    key={index}
                    ref={cardRefs}
                    className=" sm:absolute sm:-top-[20vh] transform sm:-translate-y-1/2 flex flex-col lg:flex-row backdrop-blur-[12.5px] justify-start items-center w-full border border-header-1 rounded-[10px] sm:rounded-[15px] lg:rounded-[20px] bg-global-3 p-[15px] sm:p-[25px] lg:p-[30px] xl:p-[40px] gap-[20px] lg:gap-[30px]"
                    style={{
                      boxShadow: '0 0 10px 0 rgba(106, 98, 253, 0.50) inset',
                    }}
                  >
