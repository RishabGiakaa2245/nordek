        ...
        <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col justify-start items-end w-full">
            ...
            <div className="flex relative flex-col gap-[30px] sm:gap-[45px] lg:gap-[60px] justify-start items-center w-full mt-[-26px] sm:mt-[-39px] lg:mt-[-52px]">
              ...
              {/* Products List */}
              <div className="relative w-full min-h-[300vh] flex justify-center" ref={sectionRef}>
                <div className="sticky top-0 flex h-screen items-center justify-center w-full max-w-[1234px] mb-[30px] sm:mb-[45px] lg:mb-[60px] z-10">
                  {products.map((product, index) => (
                    <div
                      key={index}
                      ref={el => cardRefs.current[index] = el}
                      className="flex absolute opacity-0 translate-y-full flex-col lg:flex-row backdrop-blur-[12.5px] justify-start items-center w-full border border-header-1 rounded-[10px] sm:rounded-[15px] lg:rounded-[20px] bg-global-3 p-[15px] sm:p-[25px] lg:p-[30px] xl:p-[40px] gap-[20px] lg:gap-[30px]"
                      style={{
                        boxShadow: '0 0 10px 0 rgba(106, 98, 253, 0.50) inset',
                      }}
                    >
