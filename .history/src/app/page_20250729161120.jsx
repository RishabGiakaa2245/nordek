...
const HomePage = () => {
  ...
  useEffect(() => {
    ...
    const section = sectio              {/* Products List */}
              <div 
                className="relative flex flex-col gap-[40px] sm:gap-[60px] lg:gap-[80px] xl:gap-[120px] w-full max-w-[1234px] mb-[30px] sm:mb-[45px] lg:mb-[60px] px-4 sm:px-6 lg:px-8"
                ref={sectionRef}
              ...
              >
                {products.map((product, index) => (
                  <div
                    ...
                    className="flex flex-col lg:flex-row backdrop-blur-[12.5px] justify-start items-center w-full border border-header-1 rounded-[10px] sm:rounded-[15px] lg:rounded-[20px] bg-global-3 p-[15px] sm:p-[25px] lg:p-[30px] xl:p-[40px] gap-[20px] lg:gap-[30px]"
                    style={{
  ...
  const industryPartners = [
    ...
    { src: '/ima4bdb9ee0061.png', width: '168', height: '24' },
...
<div className="bg-global-1 w-full">
        ...
        <div className="w-full max-w-[1440px] mx-auto relative z-10">
          <div className="flex flex-col justify-start items-center w-full">
            ...
            <div className="flex flex-col justify-start items-center w-full mt-[28px] sm:mt-[42px] lg:mt-[56px] mr-[88px] ml-[59px] sm:mr-[132px] sm:ml-[88px] lg:mr-[176px] lg:ml-[118px]">
              <div className="flex flex-col justify-start items-center w-full">
                ...
                <div className="flex flex-col justify-start mt-14 sm:mt-0 items-center w-full relative z-20">
                  <div className="flex flex-row gap-[10px] sm:gap-[15px] lg:gap-[20px] justify-center items-center w-auto">
                    <h1 className="text-[28px] sm:text-[72px] lg:text-[96px] font-poppins font-semibold leading-[50px] sm:leading-[108px] lg:leading-[144px] text-left uppercase text-global-2 drop-shadow-lg">
                      Empowering
                    </h1>
                    <h1 className="text-[28px] sm:text-[72px] lg:text-[96px] font-poppins font-semibold leading-[50px] sm:leading-[108px] lg:leading-[144px] text-right uppercase bg-[linear-gradient(134deg,#6a62fd_0%,_#4bc3ff_100%)] bg-clip-text text-transparent drop-shadow-lg">
                      Finance
                    </h1>
                  </div>
                  <h1 className="text-[28px] sm:text-[72px] lg:text-[96px] font-poppins font-semibold leading-[50px] sm:leading-[108px] lg:leading-[144px] text-center uppercase text-global-2 mt-[-22px] sm:mt-[-33px] lg:mt-[-44px] drop-shadow-lg">
                    Beyond Borders
                  </h1>
                </div>

                {/* Subtitle with Arrow */}
                <div className="flex flex-row gap-[6px] sm:gap-[9px] lg:gap-[12px] justify-center items-center w-auto mt-[5px] sm:mt-[7px] lg:mt-[10px] relative z-20">
                  <p className="text-[16px] sm:text-[24px] lg:text-[32px] font-poppins font-normal leading-[24px] sm:leading-[36px] lg:leading-[48px] text-center text-global-2 drop-shadow-md">
                    Fuel the future of Payments
                  </p>
                  <button className="bg-global-5 rounded-[8px] sm:rounded-[12px] lg:rounded-[16px] pt-[3px] pr-[3px] pb-[3px] pl-[3px] sm:pt-[4px] sm:pr-[4px] sm:pb-[4px] sm:pl-[4px] lg:pt-[6px] lg:pr-[6px] lg:pb-[6px] lg:pl-[6px] hover:bg-global-5/80 transition-all duration-300">
                    <img
              ...
              <div className="relative w-full max-w-[320px] sm:max-w-[400px] lg:max-w-[480px] h-[140px] sm:h-[160px] lg:h-[180px] mt-20 my-[40px] sm:my-[55px] lg:my-[70px] z-30">
                ...
                <div className="relative z-10 flex flex-col items-center gap-3 sm:gap-4 lg:gap-6 px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8 h-full">
                  <div className="flex items-center w-full justify-center mb-1 sm:mb-2 lg:mb-3">
                    <div className="flex-1 h-[2px] sm:h-[2.5px] lg:h-[3px] bg-gradient-to-r from-transparent via-white/60 to-white max-w-[50px] sm:max-w-[80px] lg:max-w-[120px]"></div>
                    <h3 className="text-white font-poppins text-sm sm:text-lg lg:text-xl font-medium px-2 sm:px-2.5 lg:px-3 drop-shadow-md">
                      Products
                    </h3>
                    <div className="flex-1 h-[2px] sm:h-[2.5px] lg:h-[3px] bg-gradient-to-l from-transparent via-white/60 to-white max-w-[50px] sm:max-w-[80px] lg:max-w-[120px]"></div>
                  </div>
          ...
          >
            <div className="flex flex-row justify-center items-center w-full overflow-hidden">
              ...
              <div className="relative w-[60%] overflow-hidden pt-[0px] pr-[16px] pb-[0px] pl-[16px] sm:pr-[24px] sm:pl-[24px] lg:pr-[32px] lg:pl-[32px]">
                ...
                {/* Scrolling content */}
                <div className="flex animate-scroll intems-center ">
                  {/* First set of logos */}
                  <img
      ...
      {/* About Us Section */}
      <div className="w-full mt-[60px] sm:mt-[90px] lg:mt-[120px] relative">
        {/* Left Electric Pathway */}
        <div className="absolute left-[5%] top-[25%] transform -translate-y-1/2 hidden lg:block z-0">
          <img
        ...
        <div className="absolute right-[5%] top-[25%] transform -translate-y-1/2 hidden lg:block z-0">
          <img
        ...
        <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col justify-start items-center w-full pt-[0px] pr-[28px] pb-[0px] pl-[28px] sm:pr-[42px] sm:pl-[42px] lg:pr-[56px] lg:pl-[56px]">
            ...
            <div className="flex flex-row justify-center items-center w-[84%] mt-[4px] sm:mt-[6px] lg:mt-[8px]">
              <div className="flex flex-col justify-start items-center w-full">
                <div className="flex flex-col justify-start items-center w-full">
                  <div className="flex flex-row gap-[6px] sm:gap-[9px] lg:gap-[12px] justify-center items-center w-auto">
                    <h2 className="text-[32px] sm:text-[48px] lg:text-[64px] font-poppins font-bold leading-[48px] sm:leading-[72px] lg:leading-[96px] text-left uppercase text-global-2">
                      At
                    </h2>
                    <img
                      src="/images/img_group_1707480521.svg"
                      alt="Nordek Logo"
                      className="w-[142px] h-[34px] sm:w-[213px] sm:h-[51px] lg:w-[284px] lg:h-[68px] mt-[7px] sm:mt-[10px] lg:mt-[14px] self-start"
                    />

                    <h2 className="text-[32px] text-nowrap sm:text-[48px] lg:text-[64px] font-poppins font-bold leading-[48px] sm:leading-[72px] lg:leading-[96px] text-right uppercase text-global-2">
                      , we believe
                    </h2>
                  </div>
                  <h2 className="text-[32px] sm:text-[48px] lg:text-[64px] font-poppins font-bold leading-[48px] sm:leading-[72px] lg:leading-[96px] text-center uppercase text-global-2 mt-[-10px] sm:mt-[-15px] lg:mt-[-20px]">
                    financial freedom should
                  </h2>
                </div>
                <div className="flex flex-row gap-[6px] sm:gap-[9px] lg:gap-[12px] justify-center items-center w-auto mt-[-7px] sm:mt-[-10px] lg:mt-[-14px]">
                  <h2 className="text-[32px] sm:text-[48px] lg:text-[64px] font-poppins font-bold leading-[48px] sm:leading-[72px] lg:leading-[96px] text-left uppercase text-global-2">
                    know
                  </h2>
                  <img
                    ...
                    alt="No Icon"
                    className="w-[58px] h-[34px] sm:w-[87px] sm:h-[51px] lg:w-[116px] lg:h-[68px]"
                  />

                  <h2 className="text-[32px] sm:text-[48px] lg:text-[64px] font-poppins font-bold leading-[48px] sm:leading-[72px] lg:leading-[96px] text-right uppercase text-global-2">
                    boundaries.
                  </h2>
                </div>
              </div>
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start gap-[24px] sm:gap-[80px]  lg:gap-0 w-full lg:w-[86%] mt-[40px] sm:mt-[60px] lg:mt-[80px]">
              {/* Mission Card */}

              <div className="flex flex-col gap-[16px] sm:gap-[24px] lg:gap-[32px] justify-start items-center w-full lg:w-[46%] ">
                <div
                ...
                <p className="text-[16px] sm:text-[24px] lg:text-[32px] font-poppins font-semibold leading-[24px] sm:leading-[36px] lg:leading-[48px] text-left text-global-2 w-full">
              ...
              <div className="flex flex-col gap-[16px] sm:gap-[24px] lg:gap-[32px] justify-start items-center w-full lg:w-[46%]">
                ...
                <p className="text-[16px] sm:text-[24px] lg:text-[32px] font-poppins font-semibold leading-[24px] sm:leading-[36px] lg:leading-[48px] text-left text-global-2 w-full">
                  Empowering Global Finance Through Innovation
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col justify-start items-end w-full">
            <img
              ...
              className="w-[78px] h-[80px] sm:w-[117px] sm:h-[120px] lg:w-[156px] lg:h-[160px] mr-[42px] sm:mr-[63px] lg:mr-[84px] z-50"
              animate={{ y: [0, -10, 0] }}

            />
            <div 
              className="flex flex-col gap-[30px] sm:gap-[45px] lg:gap-[60px] justify-start items-center w-full mt-[-26px] sm:mt-[-39px] lg:mt-[-52px]"
            >
              {/* Products Header */}
              <div
              ...
              >
                ...
                <div className="flex flex-col gap-[4px] sm:gap-[6px] lg:gap-[8px] justify-start items-center w-full max-w-[90%] relative z-0">
                  <div className="flex items-center w-full justify-center mb-8 sm:mb-12">
                    <div className="flex-1 h-[2px] sm:h-[3px] bg-gradient-to-r from-transparent via-cyan-300/50 to-cyan-400 max-w-[60px] sm:max-w-[100px] lg:max-w-[160px]"></div>
                    <p className="text-[8px] sm:text-[12px] lg:text-[16px] xl:text-[20px] font-poppins font-medium leading-[12px] sm:leading-[18px] lg:leading-[24px] xl:leading-[30px] text-center px-3 text-global-1 whitespace-nowrap">
                      Our Products
                    </p>
                    <div className="flex-1 h-[2px] sm:h-[3px] bg-gradient-to-l from-transparent via-cyan-300/50 to-cyan-400 max-w-[60px] sm:max-w-[100px] lg:max-w-[160px]"></div>
                  </div>
                  <h2 className="text-[24px] sm:text-[36px] lg:text-[48px] xl:text-[64px] font-poppins font-semibold leading-[30px] sm:leading-[42px] lg:leading-[60px] xl:leading-[96px] text-center text-global-2 w-full">
              ...
              {/* Products List */}
              <div 
                className="relative flex flex-col gap-[40px] sm:gap-[60px] lg:gap-[80px] xl:gap-[120px] w-full max-w-[1234px] mb-[30px] sm:mb-[45px] lg:mb-[60px] px-4 sm:px-6 lg:px-8 z-10"
                // ref={containerRef}
              >
                {products.map((product, index) => (
                  <div
                    key={index}
                    className=" sm:absolute sm:-top-[50vh] transform sm:-translate-y-1/2 flex flex-col lg:flex-row backdrop-blur-[12.5px] justify-start items-center w-full border border-header-1 rounded-[10px] sm:rounded-[15px] lg:rounded-[20px] bg-global-3 p-[15px] sm:p-[25px] lg:p-[30px] xl:p-[40px] gap-[20px] lg:gap-[30px]"
                    style={{
                      boxShadow: '0 0 10px 0 rgba(106, 98, 253, 0.50) inset',
                    }}
