          ...
          <div className="flex flex-col justify-start items-center w-full">
            ...
            <div className="flex flex-col justify-start items-center w-full  sm:mt-[42px] lg:mt-[56px]   sm:mr-[132px] sm:ml-[88px] lg:mr-[176px] lg:ml-[118px]">
              ...
              <motion.div 
                ...
                className="relative w-full mt-[65px] sm:mt-[97px] lg:mt-[130px] overflow-hidden z-30"
              >
                {/* Title */}
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                ...
                >
                  <h4 className="text-white/80 text-sm sm:text-base lg:text-lg font-medium">
                    Trusted by Industry Leaders
                  </h4>
                  <div className="w-20 h-[2px] bg-gradient-to-r from-[#6a62fd] to-[#4bc3ff] mx-auto mt-2"/>
                </motion.div>

                {/* Double scroller for infinite loop effect */}
                <div className="relative">
                  {/* Gradient overlays */}
                  <div className="absolute left-0 top-0 w-32 h-full bg-gradient-to-r from-global-1 to-transparent z-10"/>
                  <div className="absolute right-0 top-0 w-32 h-full bg-gradient-to-l from-global-1 to-transparent z-10"/>
                      ...
                      {industryPartners.map((partner, index) => (
                        ...
                        >
                          <motion.img
                            src={partner.src}
                            alt={`Partner ${index + 1}`}
                            className={`flex-shrink-0 w-[${Math.floor(parseInt(partner.width) * 0.5)}px] h-[${Math.floor(parseInt(partner.height) * 0.5)}px] sm:w-[${Math.floor(parseInt(partner.width) * 0.75)}px] sm:h-[${Math.floor(parseInt(partner.height) * 0.5)}px] lg:w-[${partner.width}px] lg:h-[${partner.height}px] drop-shadow-sm transition-opacity duration-300 group-hover:opacity-100 opacity-70`}
                          />
                        </motion.div>
                      ))}
                    </motion.div>
              ...
              <div className="flex flex-col justify-start items-center w-full">
                <div className="flex flex-col justify-start items-center w-full">
                  <div className="flex flex-row gap-[6px] sm:gap-[9px] lg:gap-[12px] justify-center items-center w-auto">
                    <h2 className="text-[20px] sm:text-[48px] lg:text-[64px] font-poppins font-bold leading-[48px] sm:leading-[72px] lg:leading-[96px] text-left uppercase text-global-2">
                      At
                    </h2>
                    <img
                      src="/images/img_group_1707480521.svg"
                      alt="Nordek Logo"
                      className="w-[92px] h-auto sm:w-[213px] sm:h-[51px] lg:w-[284px] lg:h-[68px] mt-[7px] sm:mt-[10px] lg:mt-[14px] self-start"
                    />

                    <h2 className="text-[20px] text-nowrap sm:text-[48px] lg:text-[64px] font-poppins font-bold leading-[48px] sm:leading-[72px] lg:leading-[96px] text-right uppercase text-global-2">
                      , we believe
                    </h2>
                  </div>
                  <h2 className="text-[20px] sm:text-[48px] lg:text-[64px] font-poppins font-bold leading-[48px] sm:leading-[72px] lg:leading-[96px] text-center uppercase text-global-2 mt-[-10px] sm:mt-[-15px] lg:mt-[-20px]">
                ...
                <div className="flex flex-row gap-[6px] sm:gap-[9px] lg:gap-[12px] justify-center items-center w-auto mt-[-7px] sm:mt-[-10px] lg:mt-[-14px]">
                  ...
                  <h2 className="text-[20px] sm:text-[48px] lg:text-[64px] font-poppins font-bold leading-[48px] sm:leading-[72px] lg:leading-[96px] text-right uppercase text-global-2">
                    boundaries.
                  </h2>
                </div>
              </div>
