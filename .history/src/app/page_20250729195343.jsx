              ...
              <div className="flex flex-col justify-start items-center w-full">
                ...
                <div className="flex flex-col justify-start mt-14 sm:mt-0 items-center w-full relative z-20">
                  <div className="stagger-delay flex flex-row gap-[10px] sm:gap-[15px] lg:gap-[20px] justify-center items-center w-auto">
                    <h1 className="fade-up text-[28px] sm:text-[72px] lg:text-[96px] font-poppins font-semibold leading-[50px] sm:leading-[108px] lg:leading-[144px] text-left uppercase text-global-2 drop-shadow-lg">
                      Empowering
                    </h1>
                    <h1 className="fade-up text-[28px] sm:text-[72px] lg:text-[96px] font-poppins font-semibold leading-[50px] sm:leading-[108px] lg:leading-[144px] text-right uppercase bg-[linear-gradient(134deg,#6a62fd_0%,_#4bc3ff_100%)] bg-clip-text text-transparent drop-shadow-lg">
                      Finance
                    </h1>
                  </div>
                  <h1 className="fade-up text-[28px] sm:text-[72px] lg:text-[96px] font-poppins font-semibold leading-[50px] sm:leading-[108px] lg:leading-[144px] text-center uppercase text-global-2 mt-[-22px] sm:mt-[-33px] lg:mt-[-44px] drop-shadow-lg">
                    Beyond Borders
                  </h1>
                </div>
