    ...
    if (typeof window !== 'undefined') {
      ...
      cards.forEach((card, index) => {
        tl.to(card, {
          ...
          duration: 1,
          ease: "power3.inOut"
        }, index * 0.3); // Stagger timing between cards
      });
...
<div className="bg-global-1 w-full">
      ...
      <div className="w-full mt-[6px] sm:mt-[9px] lg:mt-[12px]">
        <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col justify-start items-end w-full" ref={sectionRef}> 
            <img
            ...
            >
              ...
              {/* Products List */}
              <div 
                className="relative flex flex-col gap-[40px] w-full max-w-[1234px] mb-[30px] sm:mb-[45px] lg:mb-[60px] px-4 sm:px-6 lg:px-8 z-10 min-h-[300vh]"
              >
