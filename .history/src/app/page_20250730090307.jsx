              ...
              <div className="flex flex-col justify-start items-center w-full">
                <div className="flex flex-col justify-start items-center w-full">
                  <div className="flex flex-row gap-[6px] sm:gap-[9px] lg:gap-[12px] justify-center items-center w-auto">
                    <h2 className="text-[28px] sm:text-[48px] lg:text-[64px] font-poppins font-bold leading-[48px] sm:leading-[72px] lg:leading-[96px] text-left uppercase text-global-2">
                      At
                    </h2>
                    <img
                    ...
                    <h2 className="text-[28px] text-nowrap sm:text-[48px] lg:text-[64px] font-poppins font-bold leading-[48px] sm:leading-[72px] lg:leading-[96px] text-right uppercase text-global-2">
                      , we believe
                    </h2>
                  </div>
                  <h2 className="text-[28px] sm:text-[48px] lg:text-[64px] font-poppins font-bold leading-[48px] sm:leading-[72px] lg:leading-[96px] text-center uppercase text-global-2 mt-[-10px] sm:mt-[-15px] lg:mt-[-20px]">
                ...
                <div className="flex flex-row gap-[6px] sm:gap-[9px] lg:gap-[12px] justify-center items-center w-auto mt-[-7px] sm:mt-[-10px] lg:mt-[-14px]">
                  ...
                  <h2 className="text-[28px] sm:text-[48px] lg:text-[64px] font-poppins font-bold leading-[48px] sm:leading-[72px] lg:leading-[96px] text-right uppercase text-global-2">
                    boundaries.
                  </h2>
                </div>
              </div>
