...
const HomePage = () => {
  ...
  return (
    <div className="bg-global-1 w-full">
              ...
              <div className="flex flex-col justify-start items-center w-full">
                <div className="flex flex-col justify-start items-center w-full">
                  <div className="flex flex-row gap-[6px] sm:gap-[9px] lg:gap-[12px] justify-center items-center w-auto">
                    <h2 className="text-[25px] sm:text-[48px] lg:text-[64px] font-poppins font-bold leading-[48px] sm:leading-[72px] lg:leading-[96px] text-left uppercase text-global-2">
                      At
                    </h2>
                    <img
                      src="/images/img_group_1707480521.svg"
                      alt="Nordek Logo"
                      className="w-[112px] h-auto sm:w-[213px] sm:h-[51px] lg:w-[284px] lg:h-[68px] mt-[7px] sm:mt-[10px] lg:mt-[14px] self-start"
                    />

                    <h2 className="text-[25px] text-nowrap sm:text-[48px] lg:text-[64px] font-poppins font-bold leading-[48px] sm:leading-[72px] lg:leading-[96px] text-right uppercase text-global-2">
                      , we believe
                    </h2>
                  </div>
                  <h2 className="text-[25px] sm:text-[48px] lg:text-[64px] font-poppins font-bold leading-[48px] sm:leading-[72px] lg:leading-[96px] text-center uppercase text-global-2 mt-[-10px] sm:mt-[-15px] lg:mt-[-20px]">
                ...
                <div className="flex flex-row gap-[6px] sm:gap-[9px] lg:gap-[12px] justify-center items-center w-auto mt-[-7px] sm:mt-[-10px] lg:mt-[-14px]">
                  ...
                  <img
                    ...
                    alt="No Icon"
                    className="w-[48px] h-auto sm:w-[87px]  lg:w-[116px] "
                  />

                  <h2 className="text-[25px] sm:text-[48px] lg:text-[64px] font-poppins font-bold leading-[48px] sm:leading-[72px] lg:leading-[96px] text-right uppercase text-global-2">
                    boundaries.
                  </h2>
                </div>
              </div>
      ...
      <div className="w-full mt-[6px] h-[350vh] sm:h-[450vh] sm:mt-[9px] lg:mt-[12px]" >
