...
const HomePage = () => {
  ...
  const partnersRef = useIntersectionObserver();
      ...
      <div className="w-full relative min-h-[80vh]  sm:min-h-screen overflow-hidden">
        ...
        <div className="w-full max-w-[1440px] mx-auto relative z-10">
          <div className="flex flex-col justify-start items-center w-full">
            ...
            {/* Main Hero Content */}
            <div ref={heroRef} className="flex flex-col justify-start items-center w-full sm:mt-[42px] lg:mt-[56px] sm:mr-[132px] sm:ml-[88px] lg:mr-[176px] lg:ml-[118px]">
              <div className="flex flex-col justify-start items-center w-full">
                {/* Hero Title */}
                <div className="flex flex-col justify-start mt-14 sm:mt-0 items-center w-full relative z-20">
                  <div className="flex flex-row gap-[10px] sm:gap-[15px] lg:gap-[20px] justify-center items-center w-auto stagger-delay">
                ...
                <div className="fade-up delay-200 flex flex-row gap-[6px] sm:gap-[9px] lg:gap-[12px] justify-center items-center w-auto mt-[5px] sm:mt-[7px] lg:mt-[10px] relative z-20">
                  ...
                  <button className="bg-global-5 rounded-[8px] sm:rounded-[12px] lg:rounded-[16px] pt-[3px] pr-[3px] pb-[3px] pl-[3px] sm:pt-[4px] sm:pr-[4px] sm:pb-[4px] sm:pl-[4px] lg:pt-[6px] lg:pr-[6px] lg:pb-[6px] lg:pl-[6px] hover:bg-global-5/80 hover-scale transition-all duration-300">
                    <img
              ...
              <div className="fade-up delay-400 hover-scale relative w-full max-w-[320px] sm:max-w-[400px] lg:max-w-[480px] h-[140px] sm:h-[160px] lg:h-[180px] mt-20 my-[40px] sm:my-[55px] lg:my-[70px] z-30">
              ...
              {/* Industry Partners */}
              <div className="fade-up delay-600 relative w-full mt-[65px] sm:mt-[97px] lg:mt-[130px] overflow-hidden z-30">
