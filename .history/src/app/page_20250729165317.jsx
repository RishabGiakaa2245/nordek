        ...
        <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col justify-start items-end w-full">
            <img
              ...
              className="w-[78px] h-[80px] sm:w-[117px] sm:h-[120px] lg:w-[156px] lg:h-[160px] mr-[42px] sm:mr-[63px] lg:mr-[84px] z-50 animate-bounce"
              animate={{ y: [0, -10, 0] }}
            ...
            >
              ...
              {/* Products List */}
              <div 
                className="flex flex-col gap-[40px] sm:gap-[60px] lg:gap-[80px] xl:gap-[120px] w-full max-w-[1234px] mb-[30px] sm:mb-[45px] lg:mb-[60px] px-4 sm:px-6 lg:px-8 z-10"
              >
