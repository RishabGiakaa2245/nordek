...
<div className="bg-global-1 w-full">
      ...
      <div className="w-full mt-[6px] sm:mt-[9px] lg:mt-[12px]">
        <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex relative flex-col justify-start items-end w-full">
            <img
            ...
            >
              ...
              <div 
                className="flex relative flex-col gap-[40px] sm:gap-[60px] lg:gap-[80px] xl:gap-[120px] w-full max-w-[1234px] mb-[30px] sm:mb-[45px] lg:mb-[60px] px-4 sm:px-6 lg:px-8 z-10"
              >
