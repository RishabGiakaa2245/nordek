      ...
      <div className="w-full mt-[60px] sm:mt-[90px] lg:mt-[120px] relative">
        ...
        <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col justify-start items-center w-full pt-[0px] pr-[28px] pb-[0px] pl-[28px] sm:pr-[42px] sm:pl-[42px] lg:pr-[56px] lg:pl-[56px]">
            ...
            >
              <div className="flex-1 h-[3px] bg-gradient-to-r from-transparent via-cyan-300/50 to-cyan-400 max-w-[80px] sm:max-w-[120px] lg:max-w-[160px]" />
              ...
              <div className="flex-1 h-[3px] bg-gradient-to-l from-transparent via-cyan-300/50 to-cyan-400 max-w-[80px] sm:max-w-[120px] lg:max-w-[160px]" />
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <motion.h2
                ...
                className="text-[20px] sm:text-[48px] lg:text-[64px] font-poppins font-bold leading-[48px] sm:leading-[72px] lg:leading-[96px] text-center uppercase text-global-2"
              >
                be accessible to everyone, not
              </motion.h2>
              <motion.h2
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              <motion.div 
                ...
                className="flex flex-row gap-[6px] sm:gap-[9px] lg:gap-[12px] justify-center items-center w-auto mt-[20px] sm:mt-[30px] lg:mt-[40px]"
                >
                  <motion.h2 
                    initial={{ opacity: 0, x: -20 }}
                    whileInView={{ opacity: 1, x: 0 }}
