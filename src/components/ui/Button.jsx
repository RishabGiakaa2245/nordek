...
const Button = ({ 
  ...
  const variants = {
    primary: 'bg-button-gradient-1 text-global-2 hover:opacity-90 active:opacity-80 focus:ring-blue-500',
    secondary: 'bg-gray-200 text-gray-800 hover:bg-gray-300 active:bg-gray-400 focus:ring-gray-300',
    outline: 'border border-button-1 text-global-2 bg-transparent hover:bg-global-7 active:bg-global-3 focus:ring-gray-300',
    ghost: 'text-global-2 bg-transparent hover:bg-global-7 active:bg-global-3 focus:ring-gray-300',
